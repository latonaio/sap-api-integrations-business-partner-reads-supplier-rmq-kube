...
import (
	...
	"io/ioutil"
	"net/http"
	sap_api_output_formatter "sap-api-integrations-business-partner-reads-supplier-rmq-kube/SAP_API_Output_Formatter"
	"strings"
	"sync"
...
func (c *SAPAPICaller) General(businessPartner string) {
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": supplierData, "function": "BusinessPartnerToSupplier"})
	if err != nil {
		c.log.Error(err)
		return
	}
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": purchasingOrganizationData, "function": "BusinessPartnerSupplierPurchasingOrganization"})
	if err != nil {
		c.log.Error(err)
		return
	}
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": partnerFunctionData, "function": "BusinessPartnerSupplierPartnerFunction"})
	if err != nil {
		c.log.Error(err)
		return
	}
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": companyData, "function": "BusinessPartnerSupplierCompany"})
	if err != nil {
		c.log.Error(err)
		return
	}
...
func (c *SAPAPICaller) Supplier(supplier string) {
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": supplierData, "function": "BusinessPartnerSupplier"})
	if err != nil {
		c.log.Error(err)
		return
	}
...
func (c *SAPAPICaller) Company(supplier, companyCode string) {
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": data, "function": "BusinessPartnerSupplierCompany"})
	if err != nil {
		c.log.Error(err)
		return
	}
